...
class MeaningsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create meaning" do
    assert_difference('Meaning.count') do
      post meanings_url, params: { meaning: { text: @meaning.text, word_id: @meaning.word_id } }
    end
  ...
  test "should update meaning" do
    patch meaning_url(@meaning), params: { meaning: { text: @meaning.text, word_id: @meaning.word_id } }
